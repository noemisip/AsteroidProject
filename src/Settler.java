...
public class Settler extends Creature {
	...
	public void RestoreMaterial(Material m) { //a telepes visszahelyez egy nyersanyagot az aszteroidara, amin epp all
		if(asteroid.GetMaterial()==null && asteroid.GetLayer()==0 && materials != null){ //a telepes csak abban az esetben helyezi el a nyersanyagot, ha
	...
	public void RemoveGate(Gate g){ //a telpes kitorol egy kaput a listajabol
		gates.remove(g);
	}
}
